    ...
    <nav className="sticky top-0 z-50 bg-gray-900/95 backdrop-blur border-b border-gray-800 shadow-[0_0_60px_-15px_rgba(96,165,250,0.3)]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex min-h-[4rem] md:min-h-[5rem] items-center justify-between flex-wrap gap-y-3 gap-x-4 py-2">
          ...
          {/* SEARCH BAR */}
          <div className="w-full md:flex-1 md:max-w-2xl order-3 lg:ml-6 md:mx-4">
          ...
          {/* AVATAR SECTION */}
          <div className="flex items-center space-x-5 order-2 md:order-3 ml-auto md:ml-0">
            <button className="relative bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full blur opacity-30 hover:opacity-50 transition-opacity" />
